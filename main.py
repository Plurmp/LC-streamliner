    ...
    if message.author.id == client.user.id:
        ...
        if message.embeds:
            ...
            for f in message.embeds[0].fields:
                if f.name.strip() == 'Tier' and f.value.strip() == 'Not set' and re.match(r'ID: 3#\d', f.footer.text):
                    await message.channel.send('**WARNING: TIER NOT SET**')
                    return
        ...
        if not cmd:
            ...
            embed.add_field(
                ...
                value='`qc [id]`: equivalent to `sauce 1#[id]` (defaults to 1#1).\n\n'
                      ...
                      '`qc del [id]`: equivalent to `sauce delete 1#[id]` (defaults to 1#1).\n\n',
                inline=True
            )
            embed.add_field(
                ...
                value='`st [id]`: equivalent to `sauce 2#[id]` (defaults to 2#1).\n\n'
                      ...
                      '`st del [id]`: equivalent to `sauce delete 2#[id]` (defaults to 2#1).\n\n',
                inline=True
            )
            embed.add_field(
                name='LC shortcuts',
                value='`lc`: equivalent to `sauce lc 3#[id]` (defaults to 3#1).\n\n'
                      ...
                      '`lc del [id]`: equivalent to `sauce delete 3#[id]` (defaults to 3#1).\n\n'
